...
let logo; 
let logoSvgText = ""; // Сюда мы загрузим текстовый/векторный код логотипа
let grid = [];
...
function preload() {
  // Прямая ссылка на ваш логотип в CDN
  let logoUrl = "https://TWY-COM.b-cdn.net/Experiments%20%7C%20WIP/onetarget%20wip/onetarget_logo.svg";

  // Загружаем картинку для отрисовки на холсте (Canvas)
  logo = loadImage(logoUrl);
  
  // Загружаем сырой код логотипа для внедрения в экспорт
  loadStrings(logoUrl, function(result) {
